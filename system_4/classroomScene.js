window.ClassroomScene = class ClassroomScene extends Phaser.Scene {
    ...
    create() {
        ...
        window.GamificationManager.ensurePointsDisplay();
        window.GamificationManager.updatePointsDisplay(window.GamificationManager.getPoints());
    ...
    shutdown() {
        ...
        window.GamificationManager.cleanup();
